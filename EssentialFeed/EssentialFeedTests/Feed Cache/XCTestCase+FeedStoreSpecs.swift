...
extension FeedStoreSpecs where Self: XCTestCase {
    ...
    func assertThatInsertDeliversErrorOnInsertionError(on sut: FeedStore, file: StaticString = #filePath, line: UInt = #line) {
        ...
        XCTAssertNotNil(insertionError, "Expected cache insertion to fail with and error", file: file, line: line)
    }
    
    func assertThatHasNoSideEffectsOnInsertionError(on sut: FeedStore, file: StaticString = #filePath, line: UInt = #line) {
    ...
    func assertThatRetrieveHasNoSideEffectsEmptyOnEmptyCache(on sut: FeedStore, file: StaticString = #filePath, line: UInt = #line) {
    ...
    func assertThatInsertDeliverNoErrorOnNonEmptyCache(on sut: FeedStore, file: StaticString = #filePath, line: UInt = #line) {
        insert((uniqueImageFeed().local, Date()), to: sut)
