...
class ValidateFeedCacheUseCaseTests : XCTestCase {
    ...
    func test_validateCahe_doesNotDeleteCacheOnEmptyCache() {
        let (sut, store) = makeSUT()
    ...
    private func expect(_ sut: LocalFeedLoader, toCompleteWith expectedResult: LocalFeedLoader.ValidationResult, when action: () -> Void, file: StaticString = #filePath, line: UInt = #line) {
        ...
        sut.validateCache { receivedResult in
            ...
            case let (.failure(receivedError as NSError), .failure(expectedEror as NSError)):
                XCTAssertEqual(receivedError, expectedEror, file: file, line: line)
            default:
